...
class HomePage:
    ...
    def __init__(self,page:Page):
        """
        Constructor to initialize the playwright page object and
        define all necessary locators
        """
        self.page=page
        # ==== Locators ====
        # using playwright 'Locator' method to identify UI elements
    ...
    def click_my_account(self):
         ...
         try:
             ...
             print(f"Exceptiom while clicking 'My Account': {e}")
             raise
